...
public class ExprMultiFieldTextType implements ExprType {
  public static final ExprType MULTI_FIELD = new ExprMultiFieldTextType();

  @Override
  public List<ExprType> getParent() {
    return Arrays.asList(KEYWORD, TEXT);
  }

  @Override
  public String name() {
    return "Elasticsearch MultiField Text";
  }
}
