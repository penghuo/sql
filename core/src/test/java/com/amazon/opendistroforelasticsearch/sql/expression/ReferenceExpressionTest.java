...
//    assertEquals(ExprCoreType.INTEGER, DSL.ref("integer_value").type(typeEnv()));
//    assertEquals(ExprCoreType.LONG, DSL.ref("long_value").type(typeEnv()));
//    assertEquals(ExprCoreType.FLOAT, DSL.ref("float_value").type(typeEnv()));
//    assertEquals(ExprCoreType.DOUBLE, DSL.ref("double_value").type(typeEnv()));
//    assertEquals(ExprCoreType.BOOLEAN, DSL.ref("boolean_value").type(typeEnv()));
//    assertEquals(ExprCoreType.STRING, DSL.ref("string_value").type(typeEnv()));
//    assertEquals(ExprCoreType.STRUCT, DSL.ref("struct_value").type(typeEnv()));
//    assertEquals(ExprCoreType.ARRAY, DSL.ref("array_value").type(typeEnv()));
