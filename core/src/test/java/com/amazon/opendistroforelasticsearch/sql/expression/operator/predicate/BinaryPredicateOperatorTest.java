...
//    assertEquals(ExprCoreType.BOOLEAN, or.type(typeEnv()));
...
//    assertEquals(ExprCoreType.BOOLEAN, xor.type(typeEnv()));
...
//    assertEquals(ExprCoreType.BOOLEAN, equal.type(typeEnv()));
...
//    assertEquals(ExprCoreType.BOOLEAN, notequal.type(typeEnv()));
//    assertEquals(!v1.value().equals(v2.value()),
...
//    assertEquals(ExprCoreType.BOOLEAN, less.type(typeEnv()));
...
//    assertEquals(ExprCoreType.BOOLEAN, lte.type(typeEnv()));
//    assertEquals(compare(v1, v2) <= 0,
...
//    assertEquals(ExprCoreType.BOOLEAN, greater.type(typeEnv()));
//    assertEquals(compare(v1, v2) > 0,
...
//    assertEquals(ExprCoreType.BOOLEAN, gte.type(typeEnv()));
//    assertEquals(compare(v1, v2) >= 0,
