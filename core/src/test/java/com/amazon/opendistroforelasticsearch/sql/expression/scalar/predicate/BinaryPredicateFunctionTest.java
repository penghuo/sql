...
class BinaryPredicateFunctionTest {
    ...
    public void test_and(Boolean v1, Boolean v2) {
        ...
        assertEquals(ExprType.BOOLEAN, and.type(null));
        assertEquals(v1 && v2, ExprValueUtils.getBooleanValue(and.valueOf(null)));
    }
    ...
    public void test_equal(ExprValue v1, ExprValue v2) {
        ...
        assertEquals(ExprType.BOOLEAN, and.type(null));
        assertEquals(v1.value().equals(v2.value()), ExprValueUtils.getBooleanValue(and.valueOf(null)));
    }
}