...
//    environment().define(age, ExprCoreType.INTEGER);
//    assertEquals(ExprCoreType.INTEGER, environment().resolve(age));
//
//    // New environment 1
//    context.push();
//    Expression city = DSL.ref("s.city");
//    environment().define(city, ExprCoreType.STRING);
//    assertEquals(ExprCoreType.INTEGER, environment().resolve(age));
//    assertEquals(ExprCoreType.STRING, environment().resolve(city));
//
//    // New environment 2
//    context.push();
//    Expression manager = DSL.ref("s.manager");
//    environment().define(manager, ExprCoreType.STRUCT);
//    assertEquals(ExprCoreType.INTEGER, environment().resolve(age));
//    assertEquals(ExprCoreType.STRING, environment().resolve(city));
//    assertEquals(ExprCoreType.STRUCT, environment().resolve(manager));
//  }
//
//  @Test
...
//        () -> environment().define(DSL.literal(ExprValueUtils.integerValue(1)), ExprCoreType.INTEGER));
